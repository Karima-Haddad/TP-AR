...
//   createStep(engine, steps, {
//     title: "S3 demande la section critique",
//     description: "S3 passe à l’état demandeur et attend le jeton.",
//     eventType: "REQUEST",
//     activeSite: 2,
//   });
...
//   createStep(engine, steps, {
//     title: "S1 reçoit le jeton",
//     description: "S1 n’est pas intéressé, donc il passe le jeton à S2.",
...
//     description: "S2 n’est pas intéressé, donc il passe le jeton à S3.",
//     eventType: "SEND_TOKEN",
//     activeSite: 1,
//     message: msg,
//   });
...
//   createStep(engine, steps, {
//     title: "S3 reçoit le jeton",
//     description: "S3 est demandeur, donc il garde le jeton.",
//     eventType: "RECEIVE_TOKEN",
//     activeSite: 2,
//     message: msg,
//   });
...
//   createStep(engine, steps, {
//     title: "S3 entre en section critique",
//     description: "Comme S3 possède le jeton et est demandeur, il entre en section critique.",
//     eventType: "ENTER_CS",
//     activeSite: 2,
//   });

//   msg = engine.release(2);

//   createStep(engine, steps, {
//     title: "S3 quitte la section critique",
//     description: "À la fin de la section critique, S3 passe le jeton à S4.",
//     eventType: "EXIT_CS",
//     activeSite: 2,
//     message: msg,
//   });
